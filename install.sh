...
#
# Usage: curl -fsSL https://raw.githubusercontent.com/KillHosein/VortexL2-main/main/install.sh | sudo bash
#
...
BIN_PATH="/usr/local/bin/killhosein"
SYSTEMD_DIR="/etc/systemd/system"
CONFIG_DIR="/etc/vortexl2"
REPO_URL="https://github.com/KillHosein/VortexL2-main.git"
REPO_BRANCH="main"
...
if command -v git &> /dev/null; then
    git clone --depth 1 --branch "$REPO_BRANCH" "$REPO_URL" "$INSTALL_DIR" 2>/dev/null || {
        ...
        curl -fsSL "https://github.com/KillHosein/VortexL2-main/archive/refs/heads/${REPO_BRANCH}.tar.gz" | \
